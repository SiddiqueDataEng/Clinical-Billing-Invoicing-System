-- SQL Agent Job Setup for Clinical Billing
...
EXEC msdb.dbo.sp_add_job
    @job_name = N'Clinical-Billing-Invoicing-System_DailyJob',
    @enabled = 1,
    @description = N'Daily processing job for Clinical Billing',
...
EXEC msdb.dbo.sp_add_jobstep
    ...
    @subsystem = N'TSQL',
    @command = N'EXEC ClinicalBillingDB.dbo.usp_DailyProcessing',
    @database_name = N'ClinicalBillingDB',
    @on_success_action = 1,
    @on_fail_action = 2;

-- Create schedule (Daily at 2:00 AM)
EXEC msdb.dbo.sp_add_schedule
    @schedule_name = N'Clinical-Billing-Invoicing-System_DailySchedule',
    @enabled = 1,
    @freq_type = 4, -- Daily
    @freq_interval = 1,
...
PRINT 'Job Name: Clinical-Billing-Invoicing-System_DailyJob';
